...
png('../figs/sampler_effects.png', width = 1600, height = 1200, res = 300)
plot_sampler_effects(
  posterior_samples = final_post, 
...
png('../figs/sampler_contrasts.png', width = 1600, height = 1200, res = 300)
plot_sampler_contrasts(
  posterior_samples = final_post, 
  sampler_mapping = sampler_mapping
)
...
```{r}
# Example usage
png('../figs/predictions_with_observed.png', width = 1600, height = 1200, res = 300)
plot_predictions_with_observed(
  back_transformed_predictions = final_post_back_transformed, 
  data = d, 
  sampler_mapping = sampler_mapping, 
