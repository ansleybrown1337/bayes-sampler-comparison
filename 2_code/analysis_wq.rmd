...
which_model <- "1.4_nc"  # Potential options: "1.0", "1.1", "1.2", "1.3", "1.4_c", "1.4_nc", "1.5_nc"
...
```{r}
png('../figs/predictions_with_observed_sim.png', width = 1600, height = 1200, res = 300)
...
for (analyte_name in names(analyte_mapping)) {
  analyte_index <- analyte_mapping[[analyte_name]]  # Get the corresponding index
  ...
  plot_predictions_with_observed(
    ...
    block_index = 1  # Adjust block index as needed
  )
  dev.off()
...
plot_predictions_with_observed(
    ...
    sampler_mapping = sampler_mapping, 
    analyte_index = 8, 
    block_index = 2  # Adjust block index as needed
  )
```
